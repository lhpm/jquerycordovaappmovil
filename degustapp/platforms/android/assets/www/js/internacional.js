...
function refresh(){
    ...
    $(cinter).append("<a data-transition=\"slide\" data-details='" + JSON.stringify(data[i]) + "' href='#paginadetalles'><div class=\"nd2-card\"><div class=\"card-media\"><img src=\""+data[i].RUTALOGO+"\"><div class=\'card-media-overlay with-background\'><div class=\"card-title has-supporting-text\"><h3 class=\"card-primary-title\">"+data[i].NOMBRE+"</h3><h5 class=\"card-subtitle\">"+data[i].DESCCOMIDA+"</h5></div><div class=\"card-action\"><div class=\"row between-xs\"><div class=\"col-xs-12\"><div class=\"box\"><a href=\"tel:"+data[i].TELEEFONO+"\" class=\"ui-btn ui-btn-inline\" style=\"display:none;margin-left:10px;position:relative;\"></a></div></div></div></div></div></div></div></a>");
     };//Fin ciclo For
     ...
     $(cinter).listview("refresh");
      ...
      $(cinter).on("click", "div a", function(e){
        ...
        $("#Detalles").append("<font style=\"font-size:3.5vw;\">MAPA</font><p><div id=\"map_canvas\" style=\"width:300px;height:500px;min-width:100%;min-height:100%;\"></div><input type=\"hidden\" id=\"coordenadax\" value="+ obj.COORDENADAX +"><input type=\"hidden\" id=\"coordenaday\" value="+ obj.COORDENADAY +">");

                          // Initialize Google Maps
latitud = $("#coordenadax").val();
longitud = $("#coordenaday").val();
