...
function refresh(){
    ...
    $(cinter).append("<li data-icon=\"plus\"><a data-transition=\"slide\" data-details='" + JSON.stringify(data[i]) + "' href='#paginadetalles'><img src=\""+data[i].RUTALOGO+"\"><h3>"+data[i].NOMBRE+"</h3><p>"+data[i].DESCRIPCION+"</p></a></li>");
     };//Fin ciclo For
