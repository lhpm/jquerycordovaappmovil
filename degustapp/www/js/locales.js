...
$(document).on("pagecreate",""+categ+"", function(){

    var db=openDatabase('Favo','2.0','Base de datos favoritosd', 3*1024*1024);

    if (categ == "#comidainternacional"){
